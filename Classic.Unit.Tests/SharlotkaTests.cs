...
namespace Classic.Unit.Tests
{
	...
	public class SharlotkaTests
	{
		...
		public void AddApples_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.AddApples());
		}
		...
		public void AddBatter_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.AddBatter());
		}
		...
		public void Bake_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.Bake());
		}
		...
		public void IsRead_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.IsReady);
		}
		...
		public void TurnOut_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.TurnOut());
		}
		...
		public void DustWithSugar_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.DustWithSugar());
		}
		...
		public void DustWithCinnamon_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.DustWithCinnamon());
		}
		...
		public void Serve_calls_state() {
			...
			_sharlotkaState.AssertWasCalled(ss => ss.Serve());
		}	 
	}
}